...
./ffm-predict /data/sidana/recsysBaselines/bug_december/ffmcountryfiles/input/userofferclicks/$countryCode.ffm.test /data/sidana/recsysBaselines/experiments/debug/fr.model /data/sidana/recsysBaselines/experiments/debug/fr.output


cd ~/recsysCode/java/src/
