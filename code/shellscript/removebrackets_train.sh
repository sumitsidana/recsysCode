...
for countryCode in "at" "be" "br" "ch" "cz" "de" "dk" "fi" "ie" "nb" "nl" "no" "pl" "pt" "ru" "se" "uk" "it" "fr"; do
    start=$(date +%s.%N)
    filename1="/data/sidana/recsysBaselines/december/stats/userClicks_$countryCode.train"
    filename2="/data/sidana/recsysBaselines/december/stats/temp/userClicks_$countryCode.train"
