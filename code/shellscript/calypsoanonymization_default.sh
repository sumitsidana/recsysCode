...
for countryCode in "at" "be" "br" "ch" "cz" "de" "dk" "es" "fi" "ie" "nb" "nl" "no" "pl" "pt" "ru" "se" "uk" "it" "fr"; do
	filename1="/data/sidana/recsysBaselines/calypsodata/files/anonymized/default/train_$countryCode.csv"
	filename2="/data/sidana/recsysBaselines/calypsodata/files/anonymized/default/test_$countryCode.csv"
